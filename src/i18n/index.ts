...
const faTranslations = {
  ...
  blog: {
    ...
    posts: {
      post1: {
        title: 'ساخت رابط کاربری سفارشی برای گردش کار بیزاگی با ری‌اکت و ریداکس',
        excerpt: 'کشف کنید چگونه با استفاده از ری‌اکت، ریداکس-تولکیت و متریال یوآی رابط کاربری بصری برای بیزاگی ساختم تا فرآیندهای سازمانی را ساده‌سازی کنم.',
